...
def get_args():
    ...
    parser.add_argument('--image_dir',
                        help="Directory for input images",default = 'tests/inputs')
    ...
    parser.add_argument('--mode',
                        ...
                        choices=['detect', 'recognize', 'extract'],default = 'extract')
    parser.add_argument('--structure_config_path',
                        help="Filepath to the structure model config file",default ="structure_config.json" )
    parser.add_argument('--structure_model_path', help="The path to the structure model",default = "tests/structure_model/TATR-v1.1-All-msft.pth")
    parser.add_argument('--detection_config_path',
                        help="Filepath to the detection model config file",default="detection_config.json")
    parser.add_argument('--detection_model_path', help="The path to the detection model",default = "tests/detection_model/pubtables1m_detection_detr_r18.pth")
    parser.add_argument('--detection_device', default="cpu")
    parser.add_argument('--structure_device', default="cpu")
    parser.add_argument('--crops', '-p', action='store_true',
                        help='Output cropped data from table detections',default = True)
    parser.add_argument('--objects', '-o', action='store_true',
                        help='Output objects')
    parser.add_argument('--cells', '-l', action='store_true',
                        help='Output cells list',default = True)
    ...
    parser.add_argument('--visualize', '-z', action='store_true',
                        help='Visualize output',default = True)
