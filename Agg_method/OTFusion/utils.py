...
import collections
import sys
import Agg.OTFusion.compute_activations as compute_activations
from Agg.OTFusion.data import get_dataloader
import train as cifar_train
import Agg.OTFusion.partition as partition
...
def get_model_activations(args, models, dataloader=None, config=None, layer_name=None, selective=False, personal_dataset = None):

    if args.act_num_samples > 0:
        if dataloader is None:
            ...
            unit_batch_train_loader = dataloader
