...
from ClientTrainFedKEMF.utils.ChannelGateutils import train_one_task, perform_task_incremental_test
...
class Appr(object):
    ...
    def train(self, t):
        ...
        train_loss,train_acc = train_one_task(self.model, self.tr_dataloader, self.nepochs, kd_model=self.cur_kd,  val_loader=self.tr_dataloader, t = t)
    ...
    def train_kd(self,t):
        ...
        for e in range(self.kd_epoch):
            for images,targets in self.tr_dataloader:
                ...
                outputs = self.cur_kd.forward(images, -1, is_cifar=False)
