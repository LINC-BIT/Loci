...
from ClientTrainFedKEMF.LongLifeMethod.KEMF_NperEWC import Appr,LongLifeTest,LongLifeTrain
...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('/data/lpyx/FedAgg/ClientTrainFedKEMF/log/FedKNOW/Nperewc_high20_dag_' + args.dataset+'_'+'round' + str(args.round) + '_frac' + str(args.frac))
    # build model
