...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('/data/lpyx/FedAgg/ClientTrainFedKEMF/log/miniimgaenet/'+args.clmethod+'/server_epoch10_high20_dag_' + args.dataset+'_'+'round' + str(args.round) + '_frac' + str(args.frac))
    # build model
    ...
    print(args.round)
    serverAgg = FedKEMF(int(args.frac * args.num_users),datasize=[3,32,32],dataname='miniimagenet')
    w_globals = []
