...
from ClientTrain.models.test import test_img_local_multi_all
from ClientTrainFedKEMF.LongLifeMethod.KEMF_EWC import Appr as EWC_Appr
from ClientTrainFedKEMF.LongLifeMethod.KEMF_EWC import LongLifeTrain as EWC_LongLifeTrain
from ClientTrainFedKEMF.LongLifeMethod.KEMF_GEM import Appr as GEM_Appr
from ClientTrainFedKEMF.LongLifeMethod.KEMF_GEM import LongLifeTrain as GEM_LongLifeTrain
from ClientTrainFedKEMF.LongLifeMethod.KEMF_FedKNOW import Appr as FedKNOW_Appr
from ClientTrainFedKEMF.LongLifeMethod.KEMF_FedKNOW import LongLifeTrain as FedKNOW_LongLifeTrain
from ClientTrainFedKEMF.LongLifeMethod.KEMF_MAS import Appr as MAS_Appr
from ClientTrainFedKEMF.LongLifeMethod.KEMF_MAS import LongLifeTrain as MAS_LongLifeTrain
from ClientTrainFedKEMF.LongLifeMethod.KEMF_Packnet import Appr as Packnet_Appr
from ClientTrainFedKEMF.LongLifeMethod.KEMF_Packnet import LongLifeTrain as Packnet_LongLifeTrain
from ClientTrainFedKEMF.LongLifeMethod.KEMF_ChannelGate import Appr as ChannelGate_Appr
from ClientTrainFedKEMF.LongLifeMethod.KEMF_ChannelGate import LongLifeTrain as ChannelGate_LongLifeTrain
...
import time
from Agg.FedKEMF import FedKEMF
...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('/data/lpyx/FedAgg/ClientTrainFedKEMF/log/multi/'+args.clmethod+'/'+args.clmethod+'local5_server_epoch10_high20_dag_' + args.dataset+'_'+'round' + str(args.round) + '_frac' + str(args.frac))
    # build model
    ...
    for idx in range(args.num_users):
        ...
        apprs.append(appr)
    print(args.round)
    serverAgg = FedKEMF(int(args.frac * args.num_users),datasize=[3,32,32],dataname='CIFAR100')
    w_globals = None
        ...
        if iter % (args.round) != args.round - 1:
            ...
            if w_globals is not None:
                for i in range(args.num_users):
                    apprs[i].kd_model.load_state_dict(w_globals)
