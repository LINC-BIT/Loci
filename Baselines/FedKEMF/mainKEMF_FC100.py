...
from ClientTrain.models.test import test_img_local_multi_all, test_img_local_all, test_img_local_all_channel
...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('/data/lpyx/FedAgg/ClientTrainKEMF/log/FC100/'+args.clmethod+'/server_epoch10_high20_dag_' + args.dataset+'_'+'round' + str(args.round) + '_frac' + str(args.frac))
    # build model
    ...
    print(args.round)
    serverAgg = FedKEMF(int(args.frac * args.num_users),datasize=[3,32,32],dataname='FC100')
    w_globals = []
