...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('/data/lpyx/FedAgg/ClientTrainFedKD/log/FC100/'+args.clmethod+'/server_epoch10_high20_dag_' + args.dataset+'_'+'round' + str(args.round) + '_frac' + str(args.frac))
    # build model
        ...
        for i in range(5):
            for ind, idx in enumerate(idxs_users):
                ...
                if args.clmethod == 'EWC':
                    ...
                    kd_models, loss, indd = Packnet_LongLifeTrain(args, appr, iter, None, idx,i)
                elif args.clmethod == 'ChannelGate':
