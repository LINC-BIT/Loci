...
from ClientTrainFedKD.LongLifeMethod.KD_MAS import Appr,LongLifeTest,LongLifeTrain
...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('/data/lpyx/FedAgg/ClientTrainFedKD/log/MAS/KD_' + args.dataset+'_'+'round' + str(args.round) + '_frac' + str(args.frac))
    # build model
