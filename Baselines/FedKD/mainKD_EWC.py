...
from ClientTrainFedKD.LongLifeMethod.KD_EWC import Appr,LongLifeTest,LongLifeTrain
...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('/data/lpyx/FedAgg/ClientTrainFedKD/log/EWC/KD_' + args.dataset+'_'+'round' + str(args.round) + '_frac' + str(args.frac))
    # build model
