...
def fisher_matrix_diag(t,dataloader, model,num_classes = 10,device=None):
    ...
    for images,target in dataloader:
        images = images.cuda()
        target = (target - num_classes * t).cuda()
...
class Appr(object):
    ...
    def train(self, t,cur_epoch):
        ...
        for e in range(self.nepochs):
            ...
            self.pack.on_epoch_end(self.packmodel.feature_net,cur_epoch,t)
    ...
    def train_epoch_head(self,t):
        ...
        for images,targets in self.tr_dataloader:
            ...
            self.optimizer.step()
        return
    def train_epoch_rep(self, t, epoch,oldpackmodel,kd_lambda = 0.0):
        self.model.train()
        self.packmodel.train()
        # Loop batches
        for images,targets in self.tr_dataloader:
...
def LongLifeTrain(args, appr, aggNum, writer,idx, cur_epoch):
    ...
    # Train
    kd_grad,loss,_ = appr.train(task,cur_epoch)
    print('-' * 100)
