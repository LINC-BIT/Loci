...
class Appr(object):
    ...
    def __init__(self, model, tr_dataloader,nepochs=100, lr=0.001, lr_min=1e-6, lr_factor=3, lr_patience=5, clipgrad=100,
        ...
        self.hiddenloss = torch.nn.MSELoss()
    ...
    def train_epoch_rep(self, t, epoch, kd_lambda = 0.0):
        ...
        for images,targets in self.tr_dataloader:
            ...
            # kd_outpus, kd_hiddens = self.cur_kd.forward(images, t, avg_act=True)
            # kd_outpus = kd_outpus[:, offset1:offset2]
            # outputs,model_hiddens = self.model.forward(images,t,avg_act=True)
            ...
            #     kd_hidden_loss += self.hiddenloss(h1/2,(h2/2).detach())
    ...
    def update_kd(self, global_grad):
        ...
        kd_optimizer.step()
        # print('a:',self.eval(0,model=self.cur_kd))
