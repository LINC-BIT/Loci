...
class Appr(object):
    ...
    def train(self, t,cur_epoch):
        ...
        for e in range(self.nepochs):
            ...
            self.train_packnet(t,cur_epoch)
            self.pack.on_epoch_end(self.model.feature_net,cur_epoch,t)
    ...
    def train_packnet(self,t,cur_epoch):
        self.model.train()
        for images, targets in self.tr_dataloader:
            ...
            # self.train_kd(images,targets,t)
