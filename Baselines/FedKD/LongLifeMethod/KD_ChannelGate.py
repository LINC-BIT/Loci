...
from ClientTrainFedKD.utils.ChannelGateutils import train_one_task, perform_task_incremental_test
import sys,os
import torch
...
class Appr(object):
    ...
    def train(self, t):
        ...
        train_loss,train_acc = train_one_task(self.model, self.tr_dataloader, self.nepochs, kd_model=self.cur_kd,  val_loader=self.tr_dataloader, t = t,kd_lambda=10)
        kd_grad = []
