...
from ClientTrainFedKD.LongLifeMethod.KD_FedKNOW import Appr,LongLifeTest,LongLifeTrain
...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('/data/lpyx/FedAgg/ClientTrainFedKD/log/FedKNOW/FedKNOW_server_dag_' + args.dataset+'_'+'round' + str(args.round) + '_frac' + str(args.frac))
    # build model
    ...
    for iter in range(args.epochs):
        ...
        for i in range(10):
            ...
            for ind, idx in enumerate(idxs_users):
                ...
                kd_models,loss, indd = LongLifeTrain(args,appr,iter,None,idx,i)
