...
from ClientTrainFedMD.utils.ChannelGateutils import train_one_task, perform_task_incremental_test, train_pub
...
class Appr(object):
    ...
    def train(self, t):
        ...
        self.cur_act = train_pub(self.model, self.optimizer, self.pub_epoch, self.pub_dataloader, t, self.global_act, self.device)
