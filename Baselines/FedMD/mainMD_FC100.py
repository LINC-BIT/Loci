...
from ClientTrain.models.test import test_img_local_multi_all, test_img_local_all_channel, test_img_local_all
...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('/data/lpyx/FedAgg/ClientTrainFedMD/log/FC100/'+args.clmethod+'/server_epoch10_high20_dag_' + args.dataset+'_'+'round' + str(args.round) + '_frac' + str(args.frac))
    # build model
    # net_glob = get_model(args)
    net_glob = SixLayerViT([3, 32, 32], outputsize=100)
    net_glob.train()
    ...
    print(args.round)
    serverAgg = FedMD(dataname='FC100')
    w_globals = []
